...
var _ jwk.Manager = &PersisterNSQL{}

func (p *PersisterNSQL) GenerateAndPersistKeySet(ctx context.Context, set, kid, alg, use string) (*jose.JSONWebKeySet, error) {
...
func (p *PersisterNSQL) AddKey(ctx context.Context, set string, key *jose.JSONWebKey) error {
...
func (p *PersisterNSQL) AddKeySet(ctx context.Context, set string, keys *jose.JSONWebKeySet) error {
	ctx, span := p.r.Tracer(ctx).Tracer().Start(ctx, "persistence.sql.AddKey")
	defer span.End()
...
func (p *PersisterNSQL) UpdateKey(ctx context.Context, set string, key *jose.JSONWebKey) error {
...
func (p *PersisterNSQL) UpdateKeySet(ctx context.Context, set string, keySet *jose.JSONWebKeySet) error {
...
func (p *PersisterNSQL) GetKey(ctx context.Context, set, kid string) (*jose.JSONWebKeySet, error) {
...
func (p *PersisterNSQL) GetKeySet(ctx context.Context, set string) (keys *jose.JSONWebKeySet, err error) {
...
func (p *PersisterNSQL) DeleteKey(ctx context.Context, set, kid string) error {
...
func (p *PersisterNSQL) DeleteKeySet(ctx context.Context, set string) error {
