...
func (p *PersisterNSQL) NewNonce(ctx context.Context, accessToken string, expiresIn time.Time) (res string, err error) {
...
func (p *PersisterNSQL) IsNonceValid(ctx context.Context, accessToken, nonce string) (err error) {
