...
var _ consent.Manager = &PersisterNSQL{}

func (p *PersisterNSQL) RevokeSubjectConsentSession(ctx context.Context, user string) error {
...
func (p *PersisterNSQL) RevokeSubjectClientConsentSession(ctx context.Context, user, client string) error {
...
func (p *PersisterNSQL) revokeConsentSession(whereStmt string, whereArgs ...interface{}) func(context.Context, *pop.Connection) error {
...
func (p *PersisterNSQL) RevokeSubjectLoginSession(ctx context.Context, subject string) error {
...
func (p *PersisterNSQL) CreateForcedObfuscatedLoginSession(ctx context.Context, session *consent.ForcedObfuscatedLoginSession) error {
...
func (p *PersisterNSQL) GetForcedObfuscatedLoginSession(ctx context.Context, client, obfuscated string) (*consent.ForcedObfuscatedLoginSession, error) {
...
// request.
func (p *PersisterNSQL) CreateConsentRequest(ctx context.Context, f *flow.Flow, req *flow.OAuth2ConsentRequest) error {
...
func (p *PersisterNSQL) GetFlowByConsentChallenge(ctx context.Context, challenge string) (*flow.Flow, error) {
...
func (p *PersisterNSQL) GetConsentRequest(ctx context.Context, challenge string) (*flow.OAuth2ConsentRequest, error) {
...
func (p *PersisterNSQL) CreateLoginRequest(ctx context.Context, req *flow.LoginRequest) (*flow.Flow, error) {
...
func (p *PersisterNSQL) GetFlow(ctx context.Context, loginChallenge string) (*flow.Flow, error) {
...
func (p *PersisterNSQL) GetLoginRequest(ctx context.Context, loginChallenge string) (*flow.LoginRequest, error) {
...
func (p *PersisterNSQL) HandleConsentRequest(ctx context.Context, f *flow.Flow, r *flow.AcceptOAuth2ConsentRequest) (*flow.OAuth2ConsentRequest, error) {
...
func (p *PersisterNSQL) VerifyAndInvalidateConsentRequest(ctx context.Context, verifier string) (*flow.AcceptOAuth2ConsentRequest, error) {
...
func (p *PersisterNSQL) HandleLoginRequest(ctx context.Context, f *flow.Flow, challenge string, r *flow.HandledLoginRequest) (lr *flow.LoginRequest, err error) {
...
func (p *PersisterNSQL) VerifyAndInvalidateLoginRequest(ctx context.Context, verifier string) (*flow.HandledLoginRequest, error) {
...
func (p *PersisterNSQL) GetRememberedLoginSession(ctx context.Context, loginSessionFromCookie *flow.LoginSession, id string) (*flow.LoginSession, error) {
...
func (p *PersisterNSQL) ConfirmLoginSession(ctx context.Context, loginSession *flow.LoginSession) error {
...
func (p *PersisterNSQL) CreateLoginSession(ctx context.Context, session *flow.LoginSession) error {
...
func (p *PersisterNSQL) DeleteLoginSession(ctx context.Context, id string) (deletedSession *flow.LoginSession, err error) {
...
func (p *PersisterNSQL) mySQLDeleteLoginSession(ctx context.Context, id string) (*flow.LoginSession, error) {
	var session flow.LoginSession
...
func (p *PersisterNSQL) FindGrantedAndRememberedConsentRequests(ctx context.Context, client, subject string) (rs []flow.AcceptOAuth2ConsentRequest, err error) {
...
func (p *PersisterNSQL) FindSubjectsGrantedConsentRequests(ctx context.Context, subject string, limit, offset int) ([]flow.AcceptOAuth2ConsentRequest, error) {
...
func (p *PersisterNSQL) FindSubjectsSessionGrantedConsentRequests(ctx context.Context, subject, sid string, limit, offset int) ([]flow.AcceptOAuth2ConsentRequest, error) {
...
func (p *PersisterNSQL) CountSubjectsGrantedConsentRequests(ctx context.Context, subject string) (int, error) {
...
func (p *PersisterNSQL) filterExpiredConsentRequests(ctx context.Context, requests []flow.AcceptOAuth2ConsentRequest) ([]flow.AcceptOAuth2ConsentRequest, error) {
...
func (p *PersisterNSQL) ListUserAuthenticatedClientsWithFrontChannelLogout(ctx context.Context, subject, sid string) ([]client.Client, error) {
...
func (p *PersisterNSQL) ListUserAuthenticatedClientsWithBackChannelLogout(ctx context.Context, subject, sid string) ([]client.Client, error) {
...
func (p *PersisterNSQL) listUserAuthenticatedClients(ctx context.Context, subject, sid, channel string) ([]client.Client, error) {
...
func (p *PersisterNSQL) CreateLogoutRequest(ctx context.Context, request *flow.LogoutRequest) error {
...
func (p PersisterNSQL) AcceptLogoutRequest(ctx context.Context, challenge string) (*flow.LogoutRequest, error) {
...
func (p PersisterNSQL) RejectLogoutRequest(ctx context.Context, challenge string) error {
...
func (p *PersisterNSQL) GetLogoutRequest(ctx context.Context, challenge string) (*flow.LogoutRequest, error) {
...
func (p *PersisterNSQL) VerifyAndInvalidateLogoutRequest(ctx context.Context, verifier string) (*flow.LogoutRequest, error) {
...
func (p *PersisterNSQL) FlushInactiveLoginConsentRequests(ctx context.Context, notAfter time.Time, limit int, batchSize int) error {
...
func (p *PersisterNSQL) mySQLConfirmLoginSession(ctx context.Context, session *flow.LoginSession) error {
