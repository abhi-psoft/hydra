...
var _ trust.GrantManager = &PersisterNSQL{}

func (p *PersisterNSQL) CreateGrant(ctx context.Context, g trust.Grant, publicKey jose.JSONWebKey) (err error) {
...
func (p *PersisterNSQL) GetConcreteGrant(ctx context.Context, id string) (_ trust.Grant, err error) {
...
func (p *PersisterNSQL) DeleteGrant(ctx context.Context, id string) (err error) {
...
func (p *PersisterNSQL) GetGrants(ctx context.Context, limit, offset int, optionalIssuer string) (_ []trust.Grant, err error) {
...
func (p *PersisterNSQL) CountGrants(ctx context.Context) (n int, err error) {
...
func (p *PersisterNSQL) GetPublicKey(ctx context.Context, issuer string, subject string, keyId string) (_ *jose.JSONWebKey, err error) {
...
func (p *PersisterNSQL) GetPublicKeys(ctx context.Context, issuer string, subject string) (_ *jose.JSONWebKeySet, err error) {
...
func (p *PersisterNSQL) GetPublicKeyScopes(ctx context.Context, issuer string, subject string, keyId string) (_ []string, err error) {
...
func (p *PersisterNSQL) IsJWTUsed(ctx context.Context, jti string) (ok bool, err error) {
...
func (p *PersisterNSQL) MarkJWTUsedForTime(ctx context.Context, jti string, exp time.Time) (err error) {
...
func (p *PersisterNSQL) sqlDataFromJWTGrant(g trust.Grant) trust.SQLData {
...
func (p *PersisterNSQL) jwtGrantFromSQlData(data trust.SQLData) trust.Grant {
	return trust.Grant{
		ID:              data.ID,
		Issuer:          data.Issuer,
...
func (p *PersisterNSQL) FlushInactiveGrants(ctx context.Context, notAfter time.Time, _ int, _ int) (err error) {
