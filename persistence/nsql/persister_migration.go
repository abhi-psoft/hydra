...
func (p *PersisterNSQL) MigrationStatus(ctx context.Context) (popx.MigrationStatuses, error) {
	if p.mbs != nil {
		return p.mbs, nil
	}
...
func (p *PersisterNSQL) MigrateDown(ctx context.Context, steps int) error {
	return errorsx.WithStack(p.mb.Down(ctx, steps))
}

func (p *PersisterNSQL) MigrateUp(ctx context.Context) error {
...
func (p *PersisterNSQL) MigrateUpTo(ctx context.Context, steps int) (int, error) {
	if err := p.migrateOldMigrationTables(); err != nil {
		return 0, err
	}
...
func (p *PersisterNSQL) PrepareMigration(_ context.Context) error {
...
func (p *PersisterNSQL) migrateOldMigrationTables() error {
