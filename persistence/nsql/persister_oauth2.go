...
var _ oauth2.AssertionJWTReader = &PersisterNSQL{}
var _ storage.Transactional = &PersisterNSQL{}
...
func (p *PersisterNSQL) sqlSchemaFromRequest(ctx context.Context, signature string, r fosite.Requester, table tableName, expiresAt time.Time) (*OAuth2RequestSQL, error) {
	subject := ""
	if r.GetSession() == nil {
...
func (r *OAuth2RequestSQL) toRequest(ctx context.Context, session fosite.Session, p *PersisterNSQL) (_ *fosite.Request, err error) {
...
func (p *PersisterNSQL) ClientAssertionJWTValid(ctx context.Context, jti string) (err error) {
...
func (p *PersisterNSQL) SetClientAssertionJWT(ctx context.Context, jti string, exp time.Time) (err error) {
...
func (p *PersisterNSQL) GetClientAssertionJWT(ctx context.Context, j string) (_ *oauth2.BlacklistedJTI, err error) {
...
func (p *PersisterNSQL) SetClientAssertionJWTRaw(ctx context.Context, jti *oauth2.BlacklistedJTI) (err error) {
...
func (p *PersisterNSQL) createSession(ctx context.Context, signature string, requester fosite.Requester, table tableName, expiresAt time.Time) error {
...
func (p *PersisterNSQL) findSessionBySignature(ctx context.Context, signature string, session fosite.Session, table tableName) (fosite.Requester, error) {
...
func (p *PersisterNSQL) deleteSessionBySignature(ctx context.Context, signature string, table tableName) error {
...
func (p *PersisterNSQL) deleteSessionByRequestID(ctx context.Context, id string, table tableName) (err error) {
...
func (p *PersisterNSQL) deactivateSessionByRequestID(ctx context.Context, id string, table tableName) (err error) {
...
func (p *PersisterNSQL) CreateAuthorizeCodeSession(ctx context.Context, signature string, requester fosite.Requester) error {
...
func (p *PersisterNSQL) GetAuthorizeCodeSession(ctx context.Context, signature string, session fosite.Session) (request fosite.Requester, err error) {
...
func (p *PersisterNSQL) InvalidateAuthorizeCodeSession(ctx context.Context, signature string) (err error) {
...
func (p *PersisterNSQL) CreateAccessTokenSession(ctx context.Context, signature string, requester fosite.Requester) (err error) {
...
func (p *PersisterNSQL) GetAccessTokenSession(ctx context.Context, signature string, session fosite.Session) (request fosite.Requester, err error) {
...
func (p *PersisterNSQL) DeleteAccessTokenSession(ctx context.Context, signature string) (err error) {
...
func (p *PersisterNSQL) CreateRefreshTokenSession(ctx context.Context, signature string, requester fosite.Requester) (err error) {
...
func (p *PersisterNSQL) GetRefreshTokenSession(ctx context.Context, signature string, session fosite.Session) (request fosite.Requester, err error) {
...
func (p *PersisterNSQL) DeleteRefreshTokenSession(ctx context.Context, signature string) (err error) {
...
func (p *PersisterNSQL) CreateOpenIDConnectSession(ctx context.Context, signature string, requester fosite.Requester) (err error) {
...
func (p *PersisterNSQL) GetOpenIDConnectSession(ctx context.Context, signature string, requester fosite.Requester) (_ fosite.Requester, err error) {
...
func (p *PersisterNSQL) DeleteOpenIDConnectSession(ctx context.Context, signature string) (err error) {
...
func (p *PersisterNSQL) GetPKCERequestSession(ctx context.Context, signature string, session fosite.Session) (_ fosite.Requester, err error) {
...
func (p *PersisterNSQL) CreatePKCERequestSession(ctx context.Context, signature string, requester fosite.Requester) (err error) {
...
func (p *PersisterNSQL) DeletePKCERequestSession(ctx context.Context, signature string) (err error) {
...
func (p *PersisterNSQL) RevokeRefreshToken(ctx context.Context, id string) (err error) {
...
func (p *PersisterNSQL) RevokeRefreshTokenMaybeGracePeriod(ctx context.Context, id string, _ string) (err error) {
	ctx, span := p.r.Tracer(ctx).Tracer().Start(ctx, "persistence.sql.RevokeRefreshTokenMaybeGracePeriod")
	defer otelx.End(span, &err)
	return p.deactivateSessionByRequestID(ctx, id, sqlTableRefresh)
}

func (p *PersisterNSQL) RevokeAccessToken(ctx context.Context, id string) (err error) {
...
func (p *PersisterNSQL) flushInactiveTokens(ctx context.Context, notAfter time.Time, limit int, batchSize int, table tableName, lifespan time.Duration) (err error) {
	/* #nosec G201 table is static */
...
func (p *PersisterNSQL) FlushInactiveAccessTokens(ctx context.Context, notAfter time.Time, limit int, batchSize int) (err error) {
...
func (p *PersisterNSQL) FlushInactiveRefreshTokens(ctx context.Context, notAfter time.Time, limit int, batchSize int) (err error) {
...
func (p *PersisterNSQL) DeleteAccessTokens(ctx context.Context, clientID string) (err error) {
